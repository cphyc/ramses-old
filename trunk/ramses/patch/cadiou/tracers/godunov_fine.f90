...
!###########################################################
!###########################################################
subroutine godunov_fine(ilevel, flux)
  use amr_commons
  use hydro_commons
  implicit none
  ...
  do igrid = 1, ncache, nvector
     ...
     call godfine1(ind_grid, ngrid, ilevel, flux)
  end do
...
!###########################################################
!###########################################################
subroutine godfine1(ind_grid, ncache, ilevel, flux)
  use amr_commons
  use hydro_commons
  use poisson_commons
  implicit none
  integer, intent(in)     :: ilevel, ncache
  integer, intent(in)     :: ind_grid(1:nvector)
  real(dp), intent(inout) :: flux(:, :, :, :, :, :)
  !-------------------------------------------------------------------
